...
3. Тексты постов (HTML), **хештеги**, поле **«Тема»** → из неё **промпт gpt-image-2** (тема поста = ядро промпта, см. skill)
4. Вызов **visual-telegram** или `gpt-image-2` (1 пост = 1 картинка)
