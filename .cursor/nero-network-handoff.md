...
=== ЛЁНЯ (SEO-АУДИТ) ===
Статус: ✅ ГОТОВО (после пересборки 28.05.2026)
URL: https://advokat-vsem.online/isk-o-zashchite-is-protiv-vas-plan-otveta/
Исправлено: blob-чанки по строкам, hero h1→p, удалён сырой JSON-LD pre, один hero, FAQ целый.
Остаётся: meta description на уровне Yoast/theme (excerpt задан); при необходимости — настройка в WP.
