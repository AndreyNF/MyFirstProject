#!/usr/bin/env python3
"""Obysk page 588 blob upload state machine (15k chunks).

Agent loop:
  python3 scripts/obysk_mcp_upload.py pending
  # CallDynamicTool Kovcheg wordpress_content_blob_append json.load(pending path)
  python3 scripts/obysk_mcp_upload.py advance '<mcp response>'
"""
...
STATE = Path("/workspace/.cursor/obysk-upload-state.json")
